...
<header class="header-absolute sticky-header @if (url()->current() == route('public.single')) header-two @else inner-page @endif">
    <div class="container container-custom-one">
        <div class="nav-container d-flex align-items-center justify-content-between breakpoint-on">
            ...
            <!-- Site Logo -->
            <div class="site-logo">
                <a href="{{ route('public.single') }}" class="main-logo">
                    <img src="{{ RvMedia::getImageUrl(theme_option(url()->current() == route('public.single') ? 'logo_white' : 'logo')) }}" alt="{{ theme_option('site_title') }}">
                </a>
                <a href="{{ route('public.single') }}" class="sticky-logo">
