        ...
        <div class="post-box mb-40">
            ...
            <div class="post-desc">
                ...
                <ul class="post-meta">
                    ...
                    <li><a href="{{ $post->url }}"><i class="far fa-calendar-alt"></i>{{ $post->created_at->translatedFormat('M d, Y') }}</a></li>
                </ul>
                ...
                <div class="post-footer">
                    <div class="author">
                        <a href="{{ $post->url }}">
                            <img src="{{ $post->author->avatar_url }}" alt="{{ $post->author->name }}" width="40" style="border-radius: 50%">
                            {{ $post->author->name }}
                        </a>
                    </div>
                    <div class="read-more">
