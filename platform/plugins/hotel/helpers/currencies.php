...
use Botble\Hotel\Facades\Currency as CurrencyFacade;
...
if (! function_exists('human_price_text')) {
    function human_price_text(float|null $price, Currency|null|string $currency, string $priceUnit = '', bool $fullNumber = false): string
    {
